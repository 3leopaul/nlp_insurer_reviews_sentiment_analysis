...
Project groups of 2 students 
Contact : Kezhan Shi : shikezhan@gmail.com 
Data exploration 
...
modeling, you will need to develop an interactive application where users can submit text in the 
chosen theme and receive a prediction, along with explanations for that prediction. This will 
allow you to apply your NLP skills in a practical manner. 
...
Tensorboard: additional 1 point) 
○ USE (Universal Sentence Embedding) or equivalents, RNN LSTM, CNN, BERT, 
or other models on Hugging Face 
○ LLM 
...
Make a small video of 5 minutes explaining and demonstrating your work